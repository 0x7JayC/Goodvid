...
- OPENROUTER_IMAGE_MODEL   → image gen for production bible (openai/dall-e-3)
  Note: gpt-5.4-image-2 requires /images/edits with reference images — different API path
